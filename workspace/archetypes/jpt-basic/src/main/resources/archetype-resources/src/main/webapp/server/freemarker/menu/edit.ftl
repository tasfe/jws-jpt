...
<form name="menuForm" id="menuForm" method="post" action="${base}/pages/menu/update/${root.menu.id?c}.html">
	<div>
		<input type="hidden" name="model.id" value="${root.menu.id}" />
	</div>
	<ul>
		<li>
			<label for="model_name">名称:</label>
			<input type="text" class="text" name="model.name" id="model_name" value="${root.menu.name!}" />
		</li>
		<li>
			<label for="model_url">地址:</label>
			<input type="text" class="text" name="model.url" id="model_url" value="${root.menu.url!}" />
		</li>
		<li>
			<label for="model_suburl">获取子菜单地址:</label>
			<input type="text" class="text" name="model.suburl" id="model_suburl" value="${root.menu.suburl!}" />
		</li>
		<li>
			<label for="model_img">图标:</label>
			<input type="text" class="text" name="model.img" id="model_img" value="${root.menu.img}" />
		...
		<li>
			...
			<input type="text" class="text" name="model.target" id="model_target" value="${root.menu.target!}" />
		</li>
		<li>
			...
			<select name="model.parentId" id="model_parentId">
				...
				<option value="${topMenu.id?c}"<#if root.menu.parentId==topMenu.id>selected="selected"</#if>>${topMenu.name}</option>
				</#list>
			</select>
		</li>
		<li>
			<label for="model_displayOrder">显示次序:</label>
			<input type="text" class="text" name="model.displayOrder" id="model_displayOrder" value="${root.menu.displayOrder}" />
		</li>
		<li class="op">
			<input type="submit" class="jpt-ajax button" name="method:update" value="保存" />
